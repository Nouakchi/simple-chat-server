...
//     room: 'lobby',
//   }
//   // client = new WebSocket('ws://127.0.0.1:8000/ws/chat/' + this.state.room + '/'); //gets room_name from the state and connects to the backend server 
...
function App() {
    const roomName = "lobby"; // Replace with dynamic room name as needed
